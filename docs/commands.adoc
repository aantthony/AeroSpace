...
== split-to-focused
----
include::aerospace-split-to-focused.adoc[tags=synopsis]
----
include::aerospace-split-to-focused.adoc[tags=purpose]
include::aerospace-split-to-focused.adoc[tags=body]
